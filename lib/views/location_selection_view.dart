import 'package:checklist/utilities/constants.dart';
import 'package:checklist/widgets/map_container.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Location',
          style: TextStyle(
              fontSize: 20.0.sp, fontFamily: 'WorkSans', color: Colors.black),
        ),
        leading: IconButton(
