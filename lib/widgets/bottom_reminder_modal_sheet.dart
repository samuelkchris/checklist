...
import 'package:checklist/models/reminder_db.dart';
import 'package:checklist/utilities/location_service.dart';
import 'package:checklist/utilities/routing_constants.dart';
...
class _BottomReminderSheetState extends State<BottomReminderSheet> {
  ...
  void initializeLocalNotifications() {
    var initializationSettingsAndroid = AndroidInitializationSettings('playstore');
    var initializationSettings = InitializationSettings(android: initializationSettingsAndroid);
    flutterLocalNotificationsPlugin.initialize(initializationSettings, onSelectNotification: onSelectNotification);
  }

  Future<dynamic> onSelectNotification(String? payload) async {
    // Navigator.of(context).push(MaterialPageRoute(builder: (_) => IndexView()));
  }
            ...
            child: Column(
              children: [
                ReminderSheetTextField(
                    ...
                    hintText: 'Reminder Title', text: '',),
                SizedBox(height: 10.0.h),
                ReminderSheetTextField(
                    taskTextController: descriptionTextController,
                    hintText: 'Reminder Description', text: '',),
                SizedBox(height: 10.0.h),
                Visibility(
                  visible: !_isSwitched,
                  child: Column(
